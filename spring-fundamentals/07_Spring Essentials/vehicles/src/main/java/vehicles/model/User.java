...
import static vehicles.constant.Constants.ROLE_ADMIN;
import static vehicles.constant.Constants.ROLE_USER;
...
//    @Size(min = 8, max = 512)
    ...
    public User(@NotNull @Size(min = 2, max = 60) String firstName, @NotNull @Size(min = 2, max = 60) String lastName, @NotNull @Size(min = 3, max = 60) String username, @NotNull @Size(min = 4, max = 80) String password, @NotNull Set<Role> roles, String imageUrl) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.username = username;
        this.password = password;
