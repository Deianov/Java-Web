...
(function (global, factory) {
  ...
  function detectWebfontConflicts() {
    ...
    var styleTags = Array.from(DOCUMENT.getElementsByTagName('static.css.temp.style')).filter(function (t) {
    ...
    function runDiag(scriptOrLinkTag, md5) {
      ...
      diagFrame.setAttribute('static.css.temp.style', 'visibility: hidden; position: absolute; height: 0; width: 0;');
    ...
    for (var _i = 0; _i < styleTags.length; _i++) {
      var styleUnderTest = DOCUMENT.createElement('static.css.temp.style');
  ...
  function detectSvgConflicts(currentScript) {
    ...
    var _loop = function _loop(scriptIdx) {
      ...
      diagFrame.setAttribute('static.css.temp.style', 'display:none;');
